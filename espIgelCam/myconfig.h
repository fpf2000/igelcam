...
struct station stationList[] = {{"ssid01","password01", true},
                                {"ssid02","password02", true},
                                {"ssid03","password03", true}};
 ...
 */
// #define URL_HOSTNAME "esp32-cam01"
